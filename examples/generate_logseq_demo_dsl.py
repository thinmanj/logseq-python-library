#!/usr/bin/env python3
"""
Logseq Demo Generator Using Builder DSL

This script creates a complete Logseq graph using the new builder DSL,
demonstrating programmatic content generation without string templates.
...
class LogseqDSLDemoGenerator:
    """Generates a comprehensive Logseq demo using the new DSL."""
    ...
    def generate_complete_demo(self):
        ...
        print("\\n✅ DSL-based Logseq demo generation completed successfully!")
        print(f"📖 Open the demo in Logseq by pointing to: {self.demo_path}")
        print(f"🎯 Start with the 'Welcome to DSL Demo' page")
    ...
    def _create_welcome_page(self, client):
        ...
        welcome = (PageBuilder("Welcome to DSL Demo")
                  ...
                  .paragraph(f"This demo was generated on {datetime.now().strftime('%Y-%m-%d at %H:%M:%S')} using the new **Logseq Builder DSL**.")
        ...
        client.create_page("Welcome to DSL Demo", welcome.build())
    ...
    def _create_task_management_demo(self, client):
        ...
        page = (PageBuilder("Task Management DSL Demo")
               .author("DSL Demo Generator")
               .created()
               .page_type("demo")
        ...
        client.create_page("Task Management DSL Demo", page.build())
    ...
    def _create_block_types_showcase(self, client):
        ...
        page = (PageBuilder("Block Types DSL Showcase")
               .author("DSL Demo Generator")  
               .created()
               .page_type("demo")
               .category("reference")
        ...
        client.create_page("Block Types DSL Showcase", page.build())
    ...
    def _create_query_examples_demo(self, client):
        ...
        author_query = DSLQueryBuilder().property("author", "DSL Demo Generator")
        ...
        client.create_page("Query Examples DSL Demo", page.build())
    ...
    def _create_workflow_demo(self, client):
        ...
        page = (PageBuilder("Workflow DSL Demo")
               .author("DSL Demo Generator")
               .created()
               .page_type("demo")
               .category("process")
        ...
        client.create_page("Workflow DSL Demo", page.build())
 ...
 {:text "{{date}} {{time}}: [[quick capture]] $INPUT"
  :media "{{date}} {{time}}: [[media]] "}
        ...
        # Enhanced custom.css
        css_content = '''/* DSL Demo Custom Styles */
...
def main():
    ...
    demo_path = Path(__file__).parent / "logseq-dsl-demo"
    generator = LogseqDSLDemoGenerator(demo_path)
